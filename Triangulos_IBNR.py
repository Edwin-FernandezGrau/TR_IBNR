...
if f_mon == 'Si':
        ...
        moneda_f =   st.sidebar.selectbox("Seleccione variable moneda ", list(base0[var_moneda].unique())  , index= 1 )
...
data_final.loc['TR Pagos Incremental'] = tr_incurridos_acum.columns
